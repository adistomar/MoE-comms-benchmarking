...
# DeepEP source: clone it separately (see README) and set DEEPEP_DIR, or place a
# "DeepEP" checkout next to this repo (default). This script lives in bench/, so
# the default sibling is ../DeepEP relative to the repo root.
